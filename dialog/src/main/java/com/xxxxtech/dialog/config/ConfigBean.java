package com.xxxxtech.dialog.config;
...
import com.xxxxtech.dialog.ActivityStackManager;
import com.xxxxtech.dialog.StyledDialog;
import com.xxxxtech.dialog.Tool;
import com.xxxxtech.dialog.adapter.SuperLvAdapter;
import com.xxxxtech.dialog.adapter.SuperLvHolder;
import com.xxxxtech.dialog.bottomsheet.BottomSheetBean;
import com.xxxxtech.dialog.building.MyDialogBuilder;
import com.xxxxtech.dialog.interfaces.MyDialogListener;
import com.xxxxtech.dialog.interfaces.MyItemDialogListener;
import com.xxxxtech.dialog.interfaces.Styleable;
import com.xxxxtech.dialog.view.DialogUtilDialogFragment;
import com.xxxxtech.dialog.view.DialogUtil_DialogActivity;
...
public class ConfigBean extends MyDialogBuilder implements Styleable {
    ...
    //三个以下按钮,颜色按此顺序
    public  @ColorRes int btn1BgColor = 0;
    public  @ColorRes int btn2BgColor= 0;
    public  @ColorRes int btn3BgColor= 0;
...
支持gridview 或者recylerview*/
    ...
    @Override
    public ConfigBean setBtnBackgroundColor(@ColorRes int btn1Color, @ColorRes int btn2Color, @ColorRes int btn3Color) {
        if (btn1Color>0)
            this.btn1BgColor = btn1Color;
        if (btn2Color>0)
            this.btn2BgColor = btn2Color;
        if (btn3Color>0)
            this.btn3BgColor = btn3Color;
        return this;
    }
