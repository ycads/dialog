package com.xxxxtech.dialog.ios;
...
public class IosAlertDialogHolder extends SuperLvHolder<ConfigBean> {
    ...
    private void setBtnTxt(Context context, ConfigBean bean) {
        ...
        Log.i("TAG", " --------->>> "+ bean.btn1BgColor +" ---- "+ bean.btn2BgColor);
        if(bean.btn1BgColor > 0) {
            btn1.setBackgroundColor(Tool.getColor(btn1.getContext(), bean.btn1BgColor));
        }
        if(bean.btn2BgColor > 0) {
            btn2.setBackgroundColor(Tool.getColor(btn2.getContext(), bean.btn2BgColor));
        }
        if(bean.btn3BgColor > 0) {
            btn3.setBackgroundColor(Tool.getColor(btn3.getContext(), bean.btn3BgColor));
        }
    }
